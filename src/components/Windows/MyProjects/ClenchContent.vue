  ...
  <div class="text-xs md:text-header-window">
    <div class="flex text-xxs md:text-xs w-full items-center justify-center md:justify-start ml-px flex-wrap gap-4 md:min-w-80 md:ml-1">
      <div class="flex flex-col items-center flex-wrap">
        <img :src="pub('/img/icons/projects/tools/vuejs.svg')" :alt="$t('common.icon') + ' vuejs'" class="w-9 h-9" />
      ...
      <div class="flex flex-col items-center flex-wrap">
        <img :src="pub('/img/icons/projects/tools/shadcn.svg')" :alt="$t('common.icon') + ' shadcn'" class="w-6 h-9" />
