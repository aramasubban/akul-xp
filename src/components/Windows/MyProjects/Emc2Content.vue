  ...
  <div class="text-xs md:text-header-window">
    <div class="flex w-full text-xxs md:text-xs  items-center justify-center md:justify-start ml-px flex-wrap gap-4 md:min-w-80 md:ml-1">
      <div class="flex flex-col items-center flex-wrap">
        <img :src="pub('/img/icons/projects/tools/wordpress.svg')" :alt="$t('common.icon') + ' Wordpress'" class="w-9 h-9" />
        <p class="font-bold mt-px">Wordpress</p>
      </div>
      <div class="flex flex-col items-center flex-wrap">
        <img :src="pub('/img/icons/projects/tools/acf.svg')" :alt="$t('common.icon') + ' Visual Studio Code'" class="w-9 h-9" />
        <p class="font-bold mt-px">ACF</p>
      </div>
      <div class="flex flex-col items-center flex-wrap">
        <img :src="pub('/img/icons/projects/tools/vscode.svg')" :alt="$t('common.icon') + ' Visual Studio Code'" class="w-9 h-9" />
        <p class="font-bold mt-px">VsCode</p>
      </div>
      <div class="flex flex-col items-center flex-wrap">
        <img :src="pub('/img/icons/projects/tools/ssh.svg')" :alt="$t('common.icon') + ' Visual Studio Code'" class="w-9 h-9 p-0.5" />
