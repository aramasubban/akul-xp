    ...
    <div class="w-full h-content-headless-toolbox bg-silver border-l-3 border-t-3 border-white py-1.5 px-1">
      ...
      >
        ...
        >
          ...
          <img v-if="cell.uncovered && !cell.mine" :src="pub('/img/icons/minesweeper/open' + cell.neighborMines + '.webp')" alt="empty" class="w-full h-full p-0.5" />
          <img v-if="cell.uncovered && cell.mine && cell.isClickedMine" :src="pub('/img/icons/minesweeper/mine-death.webp')" alt="mine" class="w-full h-full p-0.5 bg-red" />
          <img v-if="cell.uncovered && cell.mine && !cell.isClickedMine" :src="pub('/img/icons/minesweeper/mine-ceil.webp')" alt="mine" class="w-full h-full p-0.5" />
          <img v-if="!cell.uncovered && cell.flagged" :src="pub('/img/icons/minesweeper/flag.webp')" alt="flag" class="relative z-10 w-full h-full p-0.5" />
          <img v-if="!cell.uncovered && cell.questioned" :src="pub('/img/icons/minesweeper/question.webp')" alt="question" class="relative z-10 w-full h-full p-0.5" />
        </div>
      </div>
    </div>
  </div>
...
const emojiSrc = (emoji) => pub(`/img/icons/minesweeper/${emoji}.webp`)
...
// Function to get the image source for a digit
const digitSrc = (digit) => pub(`/img/icons/minesweeper/digit${digit}.webp`)
